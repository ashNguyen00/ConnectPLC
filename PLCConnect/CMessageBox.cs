...
public partial class CMessageBox : Form
{
    ...
    static string titile = "";
    public CMessageBox(string title)
    {
        InitializeComponent();
        titile = title;
        set(titile, "Do you want to process?", MessageBoxButtons.OKCancel);
    ...
    {
        CMessageBox msgBox = new CMessageBox(titile, message, MessageBoxButtons.OK);
        return msgBox.showDialog();
    }

    public static bool showMessage(string message)
    {
        CMessageBox msgBox = new CMessageBox(titile, message, MessageBoxButtons.OKCancel  );
        return msgBox.showDialog();
    }
