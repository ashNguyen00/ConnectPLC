...
namespace PLCConnect
{
    public partial class FormNumpad : Form
    {
        ...
        private void BtOK_Click(object sender, EventArgs e)
        {
            ...
            if (valid == false)
            {
                CMessageBox msgBox = new CMessageBox("CHANGE", "CHECK VALID FAIL.", MessageBoxButtons.OK);
                msgBox.ShowDialog();
                return;
            }

            double value = toDouble(TxValue.Text);
            if (value < m_minValue || value > m_maxValue)
            {
                string msg = String.Format("CHANGE", "DO YOU WANT TO CHANGE?", m_maxValue);
                CMessageBox msgBox = new CMessageBox("CHANGE", msg, MessageBoxButtons.OK);
                msgBox.ShowDialog();
                return;
            }
        ...
        public double toDouble(int value1, int value2, int digitCount)
        {
